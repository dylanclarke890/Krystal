...
namespace Krys
{
  ...
  private:
    ...
    static void Reset();
    static void Flush();
    static void ForwardRender(Ref<VertexArray> vertexArray, uint32 count, bool indexed = true, PrimitiveType PrimitiveType = PrimitiveType::Triangles);
    static void DepthPasses(bool indexed, uint32 count, PrimitiveType PrimitiveType);
