...
namespace Krys
{
  ...
  void GLShader::TrySetUniform(const char *name, int value)
  {
    GLint location = glGetProgramResourceLocation(Id, GL_UNIFORM, name);
    if (location != -1)
    {
  ...
  void GLShader::TrySetUniform(const char *name, float value)
  {
    GLint location = glGetProgramResourceLocation(Id, GL_UNIFORM, name);
    if (location != -1)
    {
  ...
  void GLShader::TrySetUniform(const char *name, int *values, uint32_t count)
  {
    GLint location = glGetProgramResourceLocation(Id, GL_UNIFORM, name);
    if (location != -1)
    {
  ...
  void GLShader::TrySetUniform(const char *name, float *values, uint32_t count)
  {
    GLint location = glGetProgramResourceLocation(Id, GL_UNIFORM, name);
    if (location != -1)
    {
  ...
  void GLShader::TrySetUniform(const char *name, const Vec2 &value)
  {
    GLint location = glGetProgramResourceLocation(Id, GL_UNIFORM, name);
    if (location != -1)
    {
  ...
  void GLShader::TrySetUniform(const char *name, const Vec3 &value)
  {
    GLint location = glGetProgramResourceLocation(Id, GL_UNIFORM, name);
    if (location != -1)
    {
  ...
  void GLShader::TrySetUniform(const char *name, const Vec4 &value)
  {
    GLint location = glGetProgramResourceLocation(Id, GL_UNIFORM, name);
    if (location != -1)
    {
  ...
  void GLShader::TrySetUniform(const char *name, const Mat3 &matrix)
  {
    GLint location = glGetProgramResourceLocation(Id, GL_UNIFORM, name);
    if (location != -1)
    {
  ...
  void GLShader::TrySetUniform(const char *name, const Mat4 &matrix)
  {
    GLint location = glGetProgramResourceLocation(Id, GL_UNIFORM, name);
    if (location != -1)
    {
