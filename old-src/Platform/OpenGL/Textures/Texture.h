...
namespace Krys::OpenGL
{
  ...
  static auto ToGLTextureMagnifyMode = [](TextureMagnifyMode mode)
  {
    switch (mode)
    {
      case TextureMagnifyMode::Nearest: return GL_NEAREST;
      case TextureMagnifyMode::Linear:  return GL_LINEAR;
      default:
      {
  ...
  static auto ToGLTextureMinifyMode = [](TextureMinifyMode mode)
  {
    switch (mode)
    {
      case TextureMinifyMode::Nearest:              return GL_NEAREST;
      case TextureMinifyMode::NearestMipmapNearest: return GL_NEAREST_MIPMAP_NEAREST;
      case TextureMinifyMode::NearestMipmapLinear:  return GL_NEAREST_MIPMAP_LINEAR;
      case TextureMinifyMode::Linear:               return GL_LINEAR;
      case TextureMinifyMode::LinearMipmapNearest:  return GL_LINEAR_MIPMAP_NEAREST;
      case TextureMinifyMode::LinearMipmapLinear:   return GL_LINEAR_MIPMAP_LINEAR;
      default:
      {
  ...
  static auto ToGLDataFormat = [](TextureInternalFormat internalFormat)
  {
    switch (internalFormat)
    {
      ...
      case TextureInternalFormat::SRGB:  return GL_RGB;
      case TextureInternalFormat::RGBA:
      case TextureInternalFormat::SRGBA: return GL_RGBA;
  ...
  static auto ToGLInternalFormat = [](TextureInternalFormat internalFormat)
  {
    switch (internalFormat)
    {
      ...
      case TextureInternalFormat::SRGB:    return GL_SRGB8;
      case TextureInternalFormat::RGBA:    return GL_RGBA8;
      case TextureInternalFormat::RGBA16F: return GL_RGBA16F;
      case TextureInternalFormat::SRGBA:   return GL_SRGB8_ALPHA8;
      case TextureInternalFormat::Depth:   return GL_DEPTH_COMPONENT24;
      case TextureInternalFormat::Auto:
      default:
      {
        KRYS_ASSERT(false, "Unsupported TextureInternalFormat", 0);
